...
The threat modeling module was assessed against standard frameworks, including the OWASP Top 10 (2021) and the CWE Top 25. The test cases and coverage mappings are detailed in Tables~\ref{tab:tm_test_cases}, \ref{tab:owasp_coverage}, and~\ref{tab:cwe_coverage}.
...
\renewcommand{\arraystretch}{1.3}
\resizebox{\textwidth}{!}{%
\begin{tabular}{|p{0.25\textwidth}|c|p{0.35\textwidth}|p{0.25\textwidth}|}
\hline
...
\hline
2 --- IoT/API (Express, NestJS, MQTT, C/C++, Edge) & 8 & Strong: correct CWE-306, CWE-798, CWE-285, CWE-319 & $\sim$85\% (Memory Safety \& Edge Cache Poisoning missing CWE) \\
\hline
...
\label{tab:cwe_coverage}
\small
\renewcommand{\arraystretch}{1.3}
\resizebox{\textwidth}{!}{%
\begin{tabular}{|l|p{0.5\textwidth}|p{0.4\textwidth}|}
\hline
...
The penetration testing module was benchmarked against public vulnerable targets. A comparison with the ZeroThreat reference scanner is presented in Tables~\ref{tab:pentest_test1} and~\ref{tab:pentest_test2}.

\begin{table}[H]
\centering
\caption{Pentest Evaluation: Test 1 --- juiceshop.zerothreat.ai}
\label{tab:pentest_test1}
\small
\renewcommand{\arraystretch}{1.3}
\resizebox{\textwidth}{!}{%
\begin{tabular}{|l|p{0.25\textwidth}|p{0.3\textwidth}|p{0.3\textwidth}|}
\hline
...
\begin{table}[H]
\centering
\caption{Pentest Evaluation: Test 2 --- brokencrystals.zerothreat.ai (API scope)}
\label{tab:pentest_test2}
\small
\renewcommand{\arraystretch}{1.3}
\resizebox{\textwidth}{!}{%
\begin{tabular}{|l|p{0.25\textwidth}|p{0.3\textwidth}|p{0.3\textwidth}|}
...
\subsection{URL \& File Threat Detection Module Evaluation}

The performance of the hybrid scanner for identifying malicious URLs and files was assessed across diverse targets. The comparative scan results are summarized in Table~\ref{tab:url_file_detection}.

\begin{table}[H]
\centering
\caption{URL \& File Threat Detection Scan Results}
\label{tab:url_file_detection}
\small
\renewcommand{\arraystretch}{1.3}
\resizebox{\textwidth}{!}{%
